    ...
    <div className="space-y-5">
      ...
      <div className="grid lg:grid-cols-3 gap-4 sm:gap-6">
        ...
        <div className="lg:col-span-2 space-y-3">
          {loading ? (
            <div className="g-card rounded-2xl p-10 text-center text-gray-400 font-sans border border-gray-100">
            ...
            <div className="g-card rounded-2xl border-gray-100 p-10 text-center">
            ...
            <div key={date} className="g-card rounded-2xl border-gray-100 shadow-sm p-4 sm:p-5">
