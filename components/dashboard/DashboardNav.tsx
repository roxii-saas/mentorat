    ...
    <nav className="g-nav sticky top-0 z-40">
      <div className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between">
        <Link href="/dashboard" className="flex items-center gap-2">
          ...
          <span className="font-serif font-bold text-[#0A0A0A] hidden sm:block">Mentorat<span className="text-[#ED03E9]">.</span></span>
        </Link>
        ...
        <button className="md:hidden p-2 rounded-xl hover:bg-[#ED03E9]/8" onClick={() => setOpen(!open)}>
      ...
      {open && (
        <div className="md:hidden bg-white/90 backdrop-blur-xl border-t border-white/50 px-4 py-3 space-y-0.5">
          {LINKS.map(({ href, label, exact, d }) => (
